...
class TestProductModel(unittest.TestCase):
    ...
    def test_find_by_unknown_category(self):
        ...
        self.assertEqual(found.first().category, Category.UNKNOWN)

    def test_find_product_by_id_logs(self):
        """It should trigger logger in find()"""
        product = ProductFactory()
        product.create()
        found = Product.find(product.id)
        self.assertIsNotNone(found)
    ...
    def test_find_by_price_with_string_formatting(self):
        """It should Find Products by Price with formatted string"""
